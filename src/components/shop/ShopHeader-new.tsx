...
import { shopConfig, formatShopText } from "@/config/shop.config";

const { brand, header, contact } = shopConfig;
...
export function ShopHeader() {
  ...
  const Logo = () => {
    // Option 1: Use image logo if configured
    if (brand.logo.image) {
      return (
        <Image 
    ...
    // Option 3: Use initials with colored background
    return (
      <div 
